...
knowledge2 = And(
    ...
    Biconditional(BKnight, Or(And(AKnave, Not(BKnave)),And(Not(AKnight), BKnight), And(AKnight, Not(BKnight)),And(Not(AKnave), BKnave))),
    Biconditional(BKnave, Not(Or(And(AKnave, Not(BKnave)),And(Not(AKnight), BKnight), And(AKnight, Not(BKnight)),And(Not(AKnave), BKnave))))
